  ...
  body: (p) => {
    ...
    if (p.reverse) {
      return `
				${standard}
				${"" /* pins */}
	  			(pad 1 thru_hole rect (at -1.7 0 ${
            p.rot
          }) (size 0.9 1.7) (drill 0.3 (offset -0.1 0)) (layers *.Cu *.Paste *.Mask) ${
        p.r1.str
      })
	  			(pad 2 thru_hole rect (at 1.7 0 ${
            p.rot
          }) (size 0.9 1.7) (drill 0.3 (offset 0.1 0)) (layers *.Cu *.Paste *.Mask) ${
        p.r2.str
      }))
      ...
      return `
			${standard}
				(pad 1 smd rect (at -1.7 0 ${p.rot}) (size 0.9 1.7) (layers B.Cu B.Paste B.Mask) ${p.r1.str})
	  		(pad 2 smd rect (at 1.7 0 ${p.rot}) (size 0.9 1.7) (layers B.Cu B.Paste B.Mask) ${p.r2.str}))
			`;
    }
  },
};
