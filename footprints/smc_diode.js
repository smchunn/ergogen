module.exports = {
  ...
  body: (p) => `
    ...
    p.ref_hide
        ...
        (attr through_hole)
        (pad 1 thru_hole rect (at -1.85 0 ${
          p.rot + 180
        }) (size 1.65 1.65) (drill 0.3 (offset 0.1 0)) (layers *.Cu *.Mask) ${
                p.to.str
              })
        (pad 2 thru_hole rect (at 1.85 0 ${
          p.rot
        }) (size 1.65 1.65) (drill 0.3 (offset 0.1 0)) (layers *.Cu *.Mask) ${
                p.from.str
              })
        ...
        (pad 1 rect (at -1.85 0 ${
          p.rot + 180
        }) (size 1.65 1.65) (layers F.Cu F.Mask) ${p.to.str})
        (pad 2 rect (at 1.85 0 ${
          p.rot
        }) (size 1.65 1.65) (layers F.Cu F.Mask) ${p.from.str})
